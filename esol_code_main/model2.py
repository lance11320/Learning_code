...
class ESMclassficationModel(nn.Module):
    def __init__(self):
        ...
        self.rnn2 = nn.GRU(input_size=hid_dim, hidden_size=hid_dim, num_layers=1, batch_first=True)
        self.attn = Attention()
    ...
    def forward(self, input_ids,attention_mask):
        ...
        out2, gru_hidden2 = self.rnn(hidden_state)
        hidden_state, atten1 = self.attn(hidden_state,out,out2,scale=1)
